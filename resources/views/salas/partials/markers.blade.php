<style>
    ...
    /* Oculta tooltip vazia caso a sala não tenha descrição */
    .marker-sala[data-tooltip=""]::after,
    .marker-sala[data-tooltip=""]::before {
...
@foreach($salas as $sala)
    ...
    <div class="marker-item marker-sala" 
        ...
        <!-- Ícone Pin -->
        <svg width="{{ $size }}" height="{{ $size }}" viewBox="0 0 24 24" fill="#2563eb" stroke="#ffffff" stroke-width="2" style="display: block; pointer-events: none; flex-shrink: 0;">
